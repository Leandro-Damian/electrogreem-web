...
const scrollUp = () =>{
    ...
    // When the scroll is higher than 350 viewport height, add the show-scroll class to the scrollpu class
...
// Activated / desactivate the theme manually with thebutton
